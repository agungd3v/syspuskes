    ...
    <div class="content-panel" style="padding: 20px">
      ...
      <table class="table table-striped table-advance table-hover" style="margin-bottom: 0">
        <div style="display: flex; align-items: center; justify-content: space-between">
          <h4><i class="fa fa-angle-right"></i> Sumber Obat Keluar</h4>
          <button class="btn btn-primary" data-toggle="modal" data-target="#openSumber">Tambah sumber obat keluar</button>
        </div>
        <hr>
        <thead>
          <tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Form Sumber Obat Keluar</h4>
                  </div>
                  <form action="{{ route('sumberkeluar.update', $sumber->id) }}" method="POST">
                    @csrf
            ...
            <div class="modal fade" id="sumdel{{ $sumber->id }}" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form action="{{ route('sumberkeluar.delete', $sumber->id) }}" method="POST">
                    @csrf
                    <div class="modal-body">
...
<div class="modal fade" id="openSumber" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('sumberkeluar.store') }}" method="POST">
        @csrf
        <div class="modal-body">
          <div class="form-group">
